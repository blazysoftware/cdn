function criarBarra(var_nome, var_avatar, var_urlWhatsapp, var_urlBack, var_mensagem, var_ativarIcon) {
  ...
  var cssIdMain = 'myCssMain';
  var cssIdShadow = 'myCssShadow';
  var cssHref = 'https://cdn.jsdelivr.net/gh/blazysoftware/cdn@v1.0.0/custom-audio.css';
  ...
  if (!document.getElementById(cssId))
  {
      ...
      link.rel  = 'stylesheet';
      link.type = 'text/css';
      link.href = 'https://cdn.jsdelivr.net/gh/blazysoftware/cdn@v1.0.0/custom-audio.css';
      link.media = 'all';
      head.appendChild(link);
  }
  }
